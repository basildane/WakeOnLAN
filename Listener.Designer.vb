...
Partial Class Listener
    ...
    Private Sub InitializeComponent()
        ...
        Me.ErrorProvider1.SetError(Me.TextBoxDetails, resources.GetString("TextBoxDetails.Error"))
        Me.ErrorProvider1.SetIconAlignment(Me.TextBoxDetails, CType(resources.GetObject("TextBoxDetails.IconAlignment"), System.Windows.Forms.ErrorIconAlignment))
        Me.ErrorProvider1.SetIconPadding(Me.TextBoxDetails, CType(resources.GetObject("TextBoxDetails.IconPadding"), Integer))
